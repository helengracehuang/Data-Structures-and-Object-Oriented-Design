...
{
public:
    Map(int size = DEFAULT_MAX_ITEMS); // Create a map that can hold at most size key/value
                                       // pairs, and if no size is passed then use
                                       // DEFAULT_MAX_ITEMS
    
    ~Map();        // A proper destructor that deletes dynamically allocated array correctly
